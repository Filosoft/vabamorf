...
1.4 CURLiga veebiteenuse kasutamise näited
    $ curl --silent --request POST --header "Content-Type: application/json" \
        localhost:7008/api/generator/version | jq
    $ curl --silent --request POST --header "Content-Type: application/json" \
        --data '{"params":{"vmetsjson":["--version"]}, "content":"tere"}'  localhost:7008/api/generator/process | jq
----------------------------------------------
...
2.2 Konteineri kokkupanemine
    $ cd ~/git/vabamorf_github/docker/flask_vmetsjson
    $ docker build -t tilluteenused/vmetsjson:2023.09.20 .
    # docker login -u tilluteenused
    # docker push tilluteenused/vmetajson:2023.09.20 .
2.3 Konteineri käivitamine
    $ docker run -p 7008:7008 tilluteenused/vmetsjson:2023.09.20
...
3.1 DockerHUBist konteineri tõmbamine
    $ docker pull tilluteenused/vmetsjson:2023.09.20 
...
4 CURLiga veebiteenuse kasutamise näited
    $ curl --silent --request POST --header "Content-Type: application/json" \
        https://smart-search.tartunlp.ai/api/generator/version | jq  
    TODO
...
@app.route('/api/generator/version', methods=['GET', 'POST'])
...
@app.route('/api/generator/process', methods=['POST'])
